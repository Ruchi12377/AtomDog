...
// ATOM Speaker/Echo Base exposes its base I2C bus on AtomS3R GPIO38/39.
// The standalone Unit/Grove port uses GPIO2/1, but PCA9685 is connected to the base SDA/SCL here.
